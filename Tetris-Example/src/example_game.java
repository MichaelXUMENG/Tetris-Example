...
import java.lang.*;
import java.io.*;
public class example_game extends JPanel implements ActionListener,KeyListener//应该是继承JPanel
{
	...
	{
		example_game myBlock = new example_game();
		mb.add(menu0);
		mb.add(menu1);
		menu0.add(mi0);
		menu0.add(mi1);
...
{
	example_game myBlock; 
    public MyTimer(example_game myBlock)
    {
